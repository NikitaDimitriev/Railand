  ...
  methods: {
    ...
    register() {
      if (this.password === this.passwordCheck) {
        ...
        this.$axios
          .post("https://rl-property.herokuapp.com/api/sign-up-user", data)
          .then(response => {
            this.showRegistrationModal = !this.showRegistrationModal;
    ...
    loginUser() {
      ...
      this.$axios
        .post("https://rl-property.herokuapp.com/api/log-in-user", data)
        .then(response => {
          this.showLoginModal = !this.showLoginModal;
    ...
    getUserId() {
      if (localStorage.getItem("auth") === "true") {
        ...
        this.$axios
          .get(`https://rl-property.herokuapp.com/api/get-current-user/${id}`)
          .then(response => {
