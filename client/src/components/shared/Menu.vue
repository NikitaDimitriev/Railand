      ...
      <div class="header__in header-inner">
        <div class="header__top">
          <div class="header__top-left">
            ...
            <ul class="header__messengers messengers">
              <li class="messengers__item">
                <a
                  href="https://wa.me/+66817371687'"
                  class="messengers__links messengers__whatsapp"
                ></a>
              </li>
              <li class="messengers__item">
                <a
                  href="viber://add?number=+66817371687"
                  class="messengers__links messengers__viber"
                ></a>
              </li>
              <li class="messengers__item">
                <a
                  href="tg://resolve?domain=nikname"
                  class="messengers__links messengers__telegram"
                ></a>
              </li>
            </ul>
          </div>
          <div class="header__top-rigth">
            ...
            <div
              class="pselect"
              :class="isActiveCselect ? 'is-active': null"
              @click="toogleSlectCurrency()"
            >
                  ...
                  <div class="popup__checkbox">
                    <div class="checkbox">
                      ...
                      <label for="remember" class="checkbox__label">
                        <span class="checkbox__title">Запомнить меня</span>
                      </label>
                    </div>
                  </div>
                  <div class="popup__links">
                    ...
                    <button
                      type="button"
                      class="popup__link btn-call-popup"
    ...
    <header class="header-mob">
      <div class="header-mob__top">
        <div class="header-mob__top-in inner">
          ...
          <button
            type="button"
            class="btn-burger js-menu"
            :class="activeMenu ? 'is-active': null"
      ...
      <div class="header-mob__drop" :class="activeMenu ? 'activeMenu': null">
        <div class="header-mob__drop-in inner">
          <nav class="header-mob__nav">
            <router-link class="header-mob__nav-link" to="/">Главная</router-link>
            <router-link to="/catalog" class="header-mob__nav-link">Недвижимость</router-link>
            <router-link to="/live-in-phuket" class="header-mob__nav-link">Жизнь на Пхукете</router-link>
            <router-link class="header-mob__nav-link" to="/faq">FAQ</router-link>
            <router-link class="header-mob__nav-link" to="/about">О нас</router-link>
            <router-link class="header-mob__nav-link" to="/contact">Контакты</router-link>
            <!-- <a href="#" class="header-mob__nav-link">Владельцам</a> -->
            <!-- <a href="#" class="header-mob__nav-link">Other</a> -->
          </nav>
          <!-- <div class="select-mob">
            <div class="select-mob__current">ЯЗЫК
              <span>
                <img src="img/rus.svg" width="23" height="15" alt="Russian flag">
              </span>
            </div>
            <ul class="select-mob__list">
              <li class="select-mob__item">
                <img src="img/gbr.svg" width="23" height="15" alt="Great Britain flag">
              </li>
            </ul>
          </div> -->
          <!-- <div class="select-mob">
            <div class="select-mob__current">Валюта
              <span>$</span>
            </div>
            <ul class="select-mob__list">
          ...
          <div class="header-mob__feedback">
            ...
            <button type="button" class="header-mob__btn btn btn_primary" @click="scrollTo">
              <span>Заполнить заявку</span>
            </button>
          </div>
          <!-- <div class="form-buttons">
            <button class="form-buttons__item btn-call-popup" data-popup="registration">
              <span>Регистрация</span>
            </button>
            <button
              class="form-buttons__item form-buttons__item_red btn-call-popup"
              data-popup="login"
            >
              <span>Войти</span>
            </button>
